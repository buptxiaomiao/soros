...
--         is_open,
        ...
        m,
        d,
        substr(date_sub(hive_date, weekday(hive_date)), 0, 11) as week_begin_date,
        substr(date_add(hive_date, 7-weekday(hive_date)), 0, 11) as week_end_date,
        substr(trunc(hive_date, 'MM'), 0, 11) as month_begin_date,
        substr(date_sub(trunc(month_add(hive_date, 1), 'MM'), 1), 0, 11) month_end_date,
